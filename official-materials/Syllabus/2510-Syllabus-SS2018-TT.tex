...
\newcommand{\TheSection}{647R}
\newcommand{\TheFinalTime}{Wednesday, May 9 4:30pm -- 7:00pm}
...
\skipday{\classday} % Wednesday (no class)
\calday[Thurday]{\classday} % Thursday
...
\textbf{\parbox[t][1.0in][t]{1.0in}{Chapter Reviews:}}
  & As we conclude the exploration of the material in a chapter of the textbook, a set of problems will be assigned in WebAssign. These assignments are typically due by 11pm on Friday after the completion of the material in class for that week. The lowest two (2) Chapter Reviews will be dropped.
  \\[8pt]
...
\textbf{Quizzes:}
  & Individual, in-class quizzes will be administered every Thursday (during weeks for which there is not a Midterm scheduled). {\bf No make-up quizzes will be permitted, but the lowest two scores will be dropped.}
  \\[8pt]
%
\textbf{Exams:}
  ...
  \newline
  \textbf{1st}: \textsl{Thursday, March 8}
  \newline
  \textbf{2nd}: \textsl{Thursdayy, April 19}
  \\
  \\
...
\textbf{\parbox[t][1.0in][t]{1.0in}{Important Dates:}}
  & \begin{tabular}{lr}
  	Last day to drop without a ``W" & January 31 \\
  	Deadline for final exam change with 3 or more finals & March 23 \\
  	Last day to drop course in MyCUInfo (``W'' recorded) & March 23 \\
...
\caltextnext{Chapter 1}

\caltextnext{Chapter 2 \\ \color{red}{Chapter 1 Review}}
\caltextnext{Section 3.1 \hspace{3em} \color{blue}{Quiz 1}\\\color{red}{Chapter 2 Review (Due on Friday)}}

\caltextnext{Sections 3.2 \& 3.3}
\caltextnext{Section 4.1 \hspace{3em} \color{blue}{Quiz 2}\\\color{red}{Chapter 3 Review (Due on Friday)}}

\caltextnext{Section 4.2}
\caltextnext{Section 5.1 \hspace{3em} \color{blue}{Quiz 3}\\\color{red}{Chapter 4 Review (Due on Friday)}}

\caltextnext{Sections 5.2 \& 5.3}
\caltextnext{Section 6.1 \hspace{3em} \color{blue}{Quiz 4}\\\color{red}{Chapter 5 Review (Due on Friday)}}

\caltextnext{Sections 6.2 \& 6.3}
\caltextnext{Section 6.4 \hspace{3em}  \color{blue}{Quiz 5}\\\color{red}{Chapter 6 Review pt 1 (Due on Friday)}}

\caltextnext{Section 6.5}
\caltextnext{Section 7.1 \hspace{3em} \color{blue}{Quiz 6}\\\color{red}{Chapter 6 Review pt 2 (Due on Friday)}}

\caltextnext{Exam 1 Review}
\caltextnext{Exam 1 \hspace{3em} \color{red}{Project 1 Due}}

\caltextnext{Section 7.2}
\caltextnext{Section 7.3 \hspace{3em} \color{blue}{Quiz 7}\\\color{red}{Chapter 7 Review pt 1 (Due on Friday)}}

\caltextnext{Section 7.4}
\caltextnext{Sections 8.1 \& 8.2 \hspace{3em} \color{blue}{Quiz 8}\\\color{red}{Chapter 7 Review pt 2 (Due on Friday)}}

\caltextnext{Section 8.3}
\caltextnext{Section 8.4 \hspace{3em} \color{blue}{Quiz 9}\\\color{red}{Chapter 8 Review pt 1 (Due on Friday)}}

\caltextnext{Section 8.5}
\caltextnext{Sections 9.1 \& 9.2 \hspace{3em} \color{blue}{Quiz 10}\\\color{red}{Chapter 8 Review pt 2 (Due on Friday)}}

\caltextnext{Exam 2 Review}
\caltextnext{Exam 2}

\caltextnext{Section 9.3}
\caltextnext{Section 10.2 \hspace{3em} \color{blue}{Quiz 11}\\\color{red}{Chapter 9 Review (Due on Friday)}}

\caltextnext{Section 10.5 \hspace{3em} \color{red}{Project 2 Due}}
\caltextnext{Final Exam Review \hspace{3em} \color{blue}{Quiz 12}\\\color{red}{Chapter 10 Review (Due on Friday)}}
% ... and so on
...
\Holiday{5/4/18}{Study Day \\ \color{red}{Chapter 10 Review}}
